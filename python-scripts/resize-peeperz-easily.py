...
# Set the path to the folder containing the peeperz that you want to resize
folder_path = r"<path_to_folder>"

# Set the desired width and height (in pixels) for the resized peeperz
# The smallest, byte-perfect size of a peeper is 40x40 pixels
new_width = 1000
new_height = 1000
